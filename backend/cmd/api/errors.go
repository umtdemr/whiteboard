...
func (app *application) logError(r *http.Request, err error) {
	...
	log.Error().Err(err).Msgf("method %s uri %s", method, uri)
}
...
func (app *application) invalidAuthenticationTokenResponse(w http.ResponseWriter, r *http.Request) {
	// WWW-Authenticate: Bearer header here to help inform or remind the client that
	// we expect them to authenticate using a bearer token.
